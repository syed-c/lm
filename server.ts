...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        <title>XML Sitemap - Dr. Liyan Massaband, D.M.D., M.P.H.</title>
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p class="desc">
              This is a clinical SEO XML Sitemap index, generated by the Dr. Liyan Massaband Core Engine for search engine discovery and crawl optimization.
            </p>
          </div>
          ...
          <div class="meta-info">
            <span>
              Total Entries: 
              <strong>
                <xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap | sitemap:urlset/sitemap:url)"/>
              </strong>
            </span>
            <span>|</span>
            <span>
              Protocol: <strong>Medical Schema V3</strong>
            </span>
            <span>|</span>
            <span>
              Learn more about <a href="https://sitemaps.org" target="_blank">Sitemaps Protocol</a>.
            </span>
          </div>
          ...
          <table>
            <thead>
              <tr>
                <th width="50%">URL Path / Location</th>
                <xsl:if test="sitemap:sitemapindex/sitemap:sitemap">
                  <th width="50%">Last Modified (UTC)</th>
                </xsl:if>
                ...
                <tr>
                  ...
                  <td>
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        <span class="badge badge-gray">0 Images</span>
                      </xsl:otherwise>
                    </xsl:choose>
                  </td>
                  <td>
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        <span class="badge badge-gray">0 Videos</span>
                      </xsl:otherwise>
                    </xsl:choose>
                  </td>
                  <td>
